...
* Настройка Openrouter(не требует): https://youtu.be/01Sxu2CnWIk

**ВК Видео**
* Общая установка и использование(требует доступ через ЕЭС, ...): https://vkvideo.ru/video-182995355_456239017
* Настройка Openrouter(не требует): https://vkvideo.ru/video-182995355_456239018

Если доступа нет(при переходе на https://aistudio.google.com/apikey выдаёт ошибку), пропустите этот шаг, просто переименуйте файл в config.yaml. Потом следуйте инструкциям из второго видео.
