...
3. Положите книгу в одну папку с .exe-файлом, запустите файл. Появится консоль с прогрессом, по окончании обработки консоль закроется, а вычитанная книга будет лежать в папке output_books.
## 📖 Описание
